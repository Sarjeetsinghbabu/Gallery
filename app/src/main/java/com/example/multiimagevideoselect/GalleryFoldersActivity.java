...
import com.example.multiimagevideoselect.utils.MarginDecoration;
import com.example.multiimagevideoselect.utils.imageFolder;
import com.example.multiimagevideoselect.utils.pictureFolderAdapter;
...
public class GalleryFoldersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (folds.isEmpty()) {
            ...
            RecyclerView.Adapter folderAdapter = new pictureFolderAdapter(folds, GalleryFoldersActivity.this);
